...
class Object3d(object):
    ...
    def __init__(self, label_file_line):
        ...
        self.type = data[0] # 'Car', 'Pedestrian', ...                                  TAKE (1)
        ...
        self.h = data[8] # box height                                                   TAKE (5)
        self.w = data[9] # box width                                                    TAKE (6)
        self.l = data[10] # box length (in meters)                                      TAKE (7)
        self.t = (data[11],data[12],data[13]) # location (x,y,z) in camera coord.       TAKE (2,3,4)
        self.dis_to_cam = np.linalg.norm(self.t)
        self.ry = data[14] # yaw angle (around Y-axis in camera coordinates) [-pi..pi]  TAKE (8)
